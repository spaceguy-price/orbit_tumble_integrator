classdef HelperOrientationViewer_MinervaII2 < matlab.System
%HelperOrientationViewer_MinervaII-2 - Orientation visualization
%
%   % EXAMPLE: Visualize fused orientation data.
%
%   fused = quaternion(1,0,0,0);
%   viewer = HelperOrientationViewer_MinervaII-2;
%   viewer(fused)
...
%   Copyright 2017-2018 The MathWorks, Inc.
    ...
    methods
        % Constructor
        function obj = HelperOrientationViewer_MinervaII2(varargin)
    ...
    methods (Access = protected)
        function setupImpl(obj, varargin)
            ...
            for i = 1:numInputs
                vizObjs{i} = MinervaII2Box(fig, currAxesPosition, t{i} , i ); %#ok<AGROW>
        ...
        function stepImpl(obj, varargin)
            ...
            for i = numInputs:-1:1
                q(:,i) = varargin{i};       % the inputs
            end
            for sampleNum = 1:size(q, 1)    % number of quaternions in the batch
                for i = 1:numInputs
                    update(vizObjs(i), q(sampleNum,i)); % update the orientation of box and axes
                end
                drawnow limitrate;
            end
        end
        ...
        function createAppWindow(obj)
            ...
            if (isempty(fig) || ~ishghandle(fig))
                fig = figure('Name', 'Orientation Viewer', ...
                             ...
                             'DockControls','off', ...
                             'Units', 'normalized', ...
                             'OuterPosition', [0 0 1 1], ... %[0 0.5 0.25 0.5]
                             'Visible', 'off', ...
                             'IntegerHandle', 'off', ...
                             'HandleVisibility', 'on', ...
                             'NextPlot', 'new', ...
