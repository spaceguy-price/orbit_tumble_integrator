classdef Orientation_Viewer < matlab.System
%Orientation visualization Tool
%
%   % EXAMPLE: Visualize fused orientation data.
%
%   fused = quaternion(1,0,0,0);
%   viewer = Orientation_Viewer;
%   viewer(fused)
...
%   Copyright 2017-2018 The MathWorks, Inc.
    ...
    methods
        % Constructor
        function obj = Orientation_Viewer(varargin)
    ...
    methods (Access = protected)
        function setupImpl(obj, varargin)
            ...
            for i = 1:numInputs
                vizObjs{i} = KHI_target(fig, currAxesPosition, t{i} , i ); %#ok<AGROW>
