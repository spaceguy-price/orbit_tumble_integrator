classdef KHI_Cylinder < handle
    %KHI_Cylinder Geometry of KHI Drums project for orientation plotting.
    %   This class is a dimension-accurate representation of the
    %   KHI DRUMS cylinder for orientation visualization purposes.
    %
    ...
    methods
        % Constructor
        function obj = KHI_Cylinder(fig,varargin)
